...
export default function OverlayFormLayout(props) {
  return (
    <div
      ref={props.overlayWrapperRef}
      className="overlayWrapper"
      onClick={(e) => {
        e.target.className === "overlayWrapper"
    ...
    >
      <div
        className={
          props.isDesktop
            ? "overlayInnerWrapper"
            : "overlayInnerWrapper overlayInnerWrapperRes"
        }
      >
        <div
          style={!props.isDesktop ? { width: "100%" } : {}}
          className={
            props.isDesktop ? "formWrapper" : "formWrapper formWrapperRes"
          }
        >
